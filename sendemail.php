...
// Create some demo data to test if it works

// Demo 1 - auction ends without any bids
// Demo 2 - auction ends with 1 bid below the reserve price
// Demo 3 - auction ends with 1 bid above the reserve price
$query = "INSERT INTO auctions (sellerEmail,title,description,categoryName,
reservePrice,endDate,startPrice,picture)
VALUES 
('jeff@hotmail.co.uk','Title','Desc','Cat',
10,'$three_minutes_ago',2,'milk.jpg'),-- Demo 1
('jeff@hotmail.co.uk','Title','Desc','Cat',
10,'$three_minutes_ago',2, 'milk.jpg'),-- Demo 2
('jeff@hotmail.co.uk','Title','Desc','Cat',
10,'$three_minutes_ago',2, 'milk.jpg')-- Demo 3";
query($query);
